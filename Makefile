...
SRCS		= $(addprefix srcs/, main.c errors.c \
	...
	$(addprefix exec/, assignments.c exec_cmd.c exec_tree.c expand_str.c strip_quotes.c expand.c path.c redirects.c back_ticks.c)\
	$(addprefix parser/, expand_token.c parse_tokens.c preliminary_parse.c tree2.c expand_tokens.c)\
	$(addprefix tokenizer/, )\
