...
SRCS		= $(addprefix srcs/, main.c errors.c init_shell.c\
	...
	$(addprefix exec/, assignments.c exec_cmd.c exec_tree.c exec_semi_and_or.c expand_str.c strip_quotes.c\
				expand.c path.c redirects.c back_ticks.c hash_path_comp.c hash_path.c)\
	$(addprefix parser/, parse_tokens.c preliminary_parse.c tree2.c expand_token.c expand_tokens.c stack.c)\
	$(addprefix tokenizer/, )\
